...
app.post('/api/requestPasswordReset', async (req, res) => {
  try {
    ...
    await sgMail.send({
      ...
      'text':  `Visit here to reset your password: https://www.aqimebaby.com/api/resetPassword?pwResetToken=${pwResetToken}.\n\nLove,\nAQI Me Baby\n\nP.S. If you didn't request a password reset, you can ignore this email.`,
      'html': `<p>Click <a href="https://www.aqimebaby.com/api/resetPassword?pwResetToken=${pwResetToken}">here</a> to reset your password.</p><p>Love,<br>AQI Me Baby</p>
