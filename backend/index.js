  ...
  try {
    ...
    try {
      await sgMail.send({
        ...
        'text': `Click here to verify your email:\nhttps://www.aqimebaby.com/api/verifyEmail?token=${newRowQuery.rows[0].email_verification_token}\n\nLove,\nAQI Me Baby\n\nP.S. If you didn't just create an AQI Me Baby account, you can ignore this.`,
        'html': `<p>Click <a href="https://www.aqimebaby.com/api/verifyEmail?token=${newRowQuery.rows[0].email_verification_token}">here</a> to verify your email.</p><p>Love,<br>AQI Me Baby</p>
        <img src="https://i.imgur.com/Inz6kz1.png" style="max-width:70px;" alt="happy cloud" />
        <br><p>P.S. If you didn't just create an AQI Me Baby account, you can ignore this.</p>
        `
      });
    } catch (err) {
