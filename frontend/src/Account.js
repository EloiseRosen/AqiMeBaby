  ...
  return (
    <>
      ...
      <div className="account-container">
        ...
        {emailConfirmed === false && <p className="error-msg account">Email unconfirmed so alerts can't be sent (check spam folder if missing); refresh page to refresh status</p>}
